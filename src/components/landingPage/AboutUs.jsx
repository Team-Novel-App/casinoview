...
export default function AboutUs() {
    ...
    return (
        <section className="min-h-[600px] bg-[#151C28] relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            cruise ships, and other tourist attractions.  Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatum harum odit facere culpa eaque, accusantium ullam repellat distinctio quo impedit.
                        </p>
                        <button 
