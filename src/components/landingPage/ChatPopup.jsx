    ...
    return (
      <>
        <button
          ...
          className={`fixed bottom-6 left-6 w-14 h-14 rounded-full bg-game-primary text-white flex items-center justify-center shadow-lg hover:bg-game-secondary transition-colors z-50 ${
