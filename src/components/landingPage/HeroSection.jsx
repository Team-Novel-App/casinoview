      ...
      <div className="relative z-20 h-full container mx-auto px-4 flex items-center">
        <div className="max-w-3xl animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-retro-signed leading-tight mb-6 animate-slide-up">
              <span
                className="inline-block animate-word-slide-up bg-clip-text bg-gradient-to-r from-[#fcb51d] to-[#f72819] text-transparent"
                style={{ animationDelay: 0.5 }}
              >
                {heroSlides[currentSlide].title}
              </span>
          </h1>
          <p className="text-lg mb-8 max-w-xl bg-clip-text bg-gradient-to-r from-[#fcb51d] to-[#f72819] text-transparent animate-fade-slide-up">
